...
# The Doctor class needs an instance method, #add_appointment, that takes in an instance of the
# Appointment class and adds that appointment to the doctor's @appointments array. The method should also tell
#  that appointment that it belongs to that doctor.
