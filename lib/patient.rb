class Patient
  ...
  # The Patient class needs an instance method, #add_appointment, that takes in an argument of an appointment
  # and adds that appointment to the @appointments array.
