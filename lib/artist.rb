...
# The Artist class needs an instance method, #add_song, that takes in an argument of
# a song and adds that song to the artist's collection of songs. The #add_song method should
